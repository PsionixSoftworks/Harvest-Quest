...
seed_pumpkin	= new ItemSeeds("Pumkin Seeds",		3, ITEM_TYPE.ITEM_TYPE_SEEDS);
seed_corn		= new ItemSeeds("Corn Seeds",		4, ITEM_TYPE.ITEM_TYPE_SEEDS);
seed_potato		= new ItemSeeds("Potato Seeds",		5, ITEM_TYPE.ITEM_TYPE_SEEDS);
seed_watermelon	= new ItemSeeds("Watermelon Seeds", 6, ITEM_TYPE.ITEM_TYPE_SEEDS);
seed_radish		= new ItemSeeds("Radish Seeds",		7, ITEM_TYPE.ITEM_TYPE_SEEDS);
